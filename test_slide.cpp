...
int main (int argc, char **argv) try
{
    ...
    dom.UserData = &my_dat;
    my_dat.nu = nu;
    my_dat.g = 10.0*8.0*nu*vmax/((double)H*(double)H);
    my_dat.g = 1e-4;
    my_dat.R = R;
    my_dat.gap = gap;
    my_dat.Ny = Ny;
    ...
    {
        dom.Particles[ip].Ff = M_PI*R*R*rhos*my_dat.g, -M_PI*R*R*(rhos/rho-1)*gy, 0.0;
    ...
    dom.InitialFromH5("test_slide2_0001.h5",g0);
    ...
    dom.modexy = 0;
    //solving
    dom.SolveIBM( Tf, dtout, "test_slide3", NULL, NULL);
